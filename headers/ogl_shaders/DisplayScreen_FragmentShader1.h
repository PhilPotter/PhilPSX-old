/*
 * This header file provides the OpenGL fragment shader for the DisplayScreen
 * routine.
 * 
 * DisplayScreen_FragmentShader1.h - Copyright Phillip Potter, 2020, under GPLv3
 */
#ifndef PHILPSX_DISPLAYSCREEN_FRAGMENTSHADER1
#define PHILPSX_DISPLAYSCREEN_FRAGMENTSHADER1

static const char *GPU_getDisplayScreen_FragmentShader1Source(void)
{
	return
	"#version 450 core\n"
	"\n"
	...
	"		float(realHorizontalRes) / float(consoleHorizontalRes);\n"
	"	float verticalScalingFactor =\n"
	"		float(realVerticalRes) / float(consoleVerticalRes);\n"
	...
	"	colour =\n"
	"		vec4(red*8.225/255.0, green*8.225/255.0, blue*8.225/255.0, 1.0);\n"
	"}\n";
}
