...
"	uvec4 rectPixel = uvec4((red >> 3) & uint(0x1F), (green >> 3) & uint(0x1F), (blue >> 3) & uint(0x1F), 0);\n"
"\n"
...
"	}\n"
"	\n"
"	// Check vram pixel if enabled, else just merge, also checking rect pixel is in draw area\n"
