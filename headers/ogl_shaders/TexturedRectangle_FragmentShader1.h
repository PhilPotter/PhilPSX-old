...
"void main(void) {\n"
"	// Get coordinate from gl_FragCoord and apply offset to make calculations easier\n"
...
"		int new_tex_x = ((tex_x + (tempDrawCoord.x % 256)) & ~(texWidthMask * 8)) | ((texWinOffsetX & texWidthMask) * 8);\n"
"		int new_tex_y = ((tex_y + (tempDrawCoord.y % 256)) & ~(texHeightMask * 8)) | ((texWinOffsetY & texHeightMask) * 8);\n"
"\n"
...
"		int clutIndex = (texPixeli >> ((tempDrawCoord.x % 4) * 4)) & 0xF;\n"
"\n"
...
"		texPixel = imageLoad(vramImage, ivec2(new_tex_x, new_tex_y));\n"
"		int texPixeli = ((int(texPixel.a) & 0x1) << 15) | ((int(texPixel.b) & 0x1F) << 10) | ((int(texPixel.g) & 0x1F) << 5) | (int(texPixel.r) & 0x1F);\n"
"		int clutIndex = (texPixeli >> ((tempDrawCoord.x % 2) * 8)) & 0xFF;\n"
"		\n"
"		// Read correct pixel from CLUT\n"
"		uvec4 clutPixel = imageLoad(vramImage, ivec2(clut_x + clutIndex, clut_y));\n"
"		texPixel.r = clutPixel.r;\n"
...
"	}\n"
"\n"
"	// Swap y coordinate round so we flip texture back to the right way up\n"
"	tempDrawCoord.y = height - 1 - tempDrawCoord.y;\n"
"\n"
"	// Get coordinate from gl_FragCoord and correctly reference vram texture\n"
...
"	}\n"
"	\n"
"	// Check vram pixel mask if enabled, else just merge, also checking it is in draw area\n"
