...
"	//uvec4 linePixel = uvec4((uint(vertexColour.r) >> 3) & uint(0x1F), (uint(vertexColour.g) >> 3) & uint(0x1F), (uint(vertexColour.b) >> 3) & uint(0x1F), 0);\n"
...
"		ivec3 ditherPixel = ivec3(int(linePixel.r), int(linePixel.g), int(linePixel.b));\n"
"\n"
...
"	}\n"
"	\n"
"	// Check vram pixel if enabled, else just merge, also checking line pixel is in draw area\n"
