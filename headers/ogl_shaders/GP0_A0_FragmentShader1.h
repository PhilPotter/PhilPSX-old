...
"void main(void) {\n"
"	// Get coordinate from gl_FragCoord and apply offset to correctly reference temp draw texture\n"
...
"	tempDrawPixel = uvec4(originalPixel & uint(0x1F), (originalPixel >> 5) & uint(0x1F), (originalPixel >> 10) & uint(0x1F), (originalPixel >> 15) & uint(0x1));\n"
"\n"
